...
Page({
  ...
  onLoad(options) {
    ...
    this.getServiceTree(options.staffId, options.shopId, JSON.parse(options.specificationIds))
  },
  // 获取服务
  getServiceTree(staffId, shopId, specificationIds) {
    apiAction.getServiceTree([staffId], shopId).then(data => {

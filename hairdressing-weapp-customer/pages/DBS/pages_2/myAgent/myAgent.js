...
Page({
  ...
  onLoad: function (options) {
    ...
    app.getBrand(brand => {
      ...
      this.weGetIntroduceShareholderPagedList().then(res => {
  ...
  weGetIntroduceShareholderPagedList(pageType = 'firstPage') {
    ...
    return apiAction.weGetIntroduceShareholderPagedList(queryParams).then(res => {

    ...
    methods: {
      ...
      isSubmit(){
        if(this.totalMoney == ''){
          ...
          if(this.totalMoney <this.noMoney){
          ...
          var totle = Number(this.totalMoney);
          var noMoney = Number(this.noMoney);

          let disNumber = Number(this.discountRate) *10;
                    ...
                    if(result.state ==1){
                      wx.showModal({
                        ...
                        success(res){
                          if (res.confirm) {
                            wx.navigateTo({
                              url:`/pages/packageB/pages/paySuc/main?orderNum=${result.data.orderNum}&shopStoreId=${_this.shopStoreId}&fromPage=MAINCARD`
                            })
                          }
                          else if(res.cancel){

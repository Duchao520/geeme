<template>
    <div class="page">
      ...
      <div class="shop_bot">
         <div class="shop_bot_title">推荐商家</div>
...
<script>
    ...
    export default {
        ...
        methods:{
          ...
          gotypePage(par){
            wx.navigateTo({
              url:`/pages/packageD/pages/typeRecome/main?industryId=${par.id}&namePath=${par.namePath}`
            })
          },
          getTypee(){
          ...
          getrecomList(_data){
            ...
            getSignIn(_data).then(sec=>{
                _this.$http.recomList(_data,sec).then(res=>{
                  // Tips.loaded();
                  if(res.data.length == 0 && _this.dataArr.length !=0) {
                    _this.noMore = true;
                  ...
                  for(let i=0;i<res.data.length;i++){
                    ...
                    if( res.data[i].shareCardDiscount) {
                  ...
                  _this.dataArr = _this.dataArr.concat(res.data) ?_this.dataArr.concat(res.data) :[];

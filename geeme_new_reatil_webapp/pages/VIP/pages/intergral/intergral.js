...
Page({
  ...
  getBrand(){
    app.getBrand((brandInfo) => {
      ...
      util.PromiseAll([
        this.getBrandCustomerIntegralStatisticalInfoApi(),
        this.getBrandMemberIntegralRuleApiByBrandId()
      ]).then(res => {
        this.setData(res)
      })
    })
  },
  getBrandCustomerIntegralStatisticalInfoApi(){
    return apiAction.getBrandCustomerIntegralStatisticalInfoApi()
  },
  getBrandMemberIntegralRuleApiByBrandId(){
    return apiAction.getBrandMemberIntegralRuleApiByBrandId(this.data.brandId)
  },
  jumpDetail(){
    wx.$route('/pages/VIP/pages/intergralDetail/intergralDetail')
  },
  jumpRule() {
    wx.$route('/pages/VIP/pages/intergralRule/intergralRule')
  }
})
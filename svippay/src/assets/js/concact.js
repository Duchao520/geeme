...
/*export const regular_uri = {
  ...
  pay: 'https://shopapi.tenzhao.com/sapi/voip/unifiedpay',
...
export const regular_uri = {
  ...
  pay: 'https://zst-test.tenzhao.com:8443/sapi/voip/unifiedpay',
  svipWxPay: 'https://zst-test.tenzhao.com:8443/sapi/svip/pubSigPay',     //svip分享卡微信支付接口
  svipAliPay: 'https://zst-test.tenzhao.com:8443/sapi/svip/aliScanPay'     //svip分享卡支付宝支付接口
};

// export const ctxPath = 'https://shopapi.tenzhao.com';
// export const AUTH_PATH = 'https://wechat.tenzhao.com/newland/pay.html';
//
export const ctxPath = 'https://zst-test.tenzhao.com:8443';
export const AUTH_PATH = 'https://wechat.tenzhao.com/pubpay-test/pay.html';

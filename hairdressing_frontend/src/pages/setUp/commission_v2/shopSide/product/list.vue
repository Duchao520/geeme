...
export default {
  ...
  methods: {
    ...
    async init() {
      ...
      let res = await axios.post('/newGetCommissionProductList', data)
      if (res.success) {
        this.tableLoading = false
        this.tableData = res.newCommissionProductInfoList || []
    ...
    // v2 改成新增和编辑都去以前的编辑页面
    toSetComssionPage() {  
      this.$router.push(`/${this.currentEntry}-inner/edit-commission-plan-product`)
    }
  },
  computed: {
    ...mapState({

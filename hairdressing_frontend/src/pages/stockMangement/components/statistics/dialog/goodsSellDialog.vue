<template>
  <div class="goods-sell-dialog">
    <el-dialog
      :title="`商品销售明细(${superParams.goodsName})`"
    ...
    >
      <div class="dialog-main" v-loading="loading">
        ...
        >
          ...
          <el-table-column label="订货单量" prop="invoiceNum"></el-table-column>
...
export default {
  ...
  methods: {
    init() {
      ...
      axios.post('/getProductInvoiceStatisticsDetail', {
        ...o, 
        ...this.superParams,
        ...
        this.tableData = res.listInvoiceStatisticsProductDetail || []

  ...
  <div v-loading.fullscreen.lock="submitLoading">
    ...
    >
      ...
      >
        ...
        <el-form-item label="门店订货原因:" style="margin-bottom: 0;">
          {{detailInfo.reason}}
        </el-form-item>
        <el-form-item label="品牌审核备注:" style="margin-bottom: 0;">
          {{detailInfo.remarks}}
        </el-form-item>
        <!-- 出入库经办人 -->
        ...
        >
          ...
          >
            ...
            <!-- 仅入库时显示?? v-if="operateType" -->
            <!-- <el-table-column label="成本价" v-if="operateType" prop="costPrice" width="90">
              <template slot-scope="scope">
                <el-form-item

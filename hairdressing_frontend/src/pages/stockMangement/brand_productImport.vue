    ...
    <div class="header-btn-line">
      <div class="left-btn">
        ...
        <el-upload
          ...
          :limit="1"
        >
          <el-button class="resize-btn normal_green_btn" :loading="btnLoad">导入库存产品信息</el-button>
        </el-upload>
      </div>
      <div class="right-btn">
...
export default {
  ...
  data() {
    return {
      ...
      productAction: `${process.env.SERVICE_URL}/service-api/importBrandStockProduct`,
      token: "",
      fileList: [], // 需求清空文件
      loading: false,
      btnLoad: false

  ...
  <div class="introduce">
    ...
    <div class="table-main">
      <el-table stripe :data="bindCustomerData" height="calc(100vh - 289px)" v-loading="loading">
        ...
        <el-table-column label="权益门店" v-if="isBrand" width="180" show-overflow-tooltip>
    ...
    async init() {
      try {
        ...
        const [res_1, res_2] = await Promise.all([
          axios.post("/getBrandIntroduceShareholderBindPagedList", {
            ...this.params,
        ...
        this.bindCustomerData = res_1.introduceShareholderBindInfoList;

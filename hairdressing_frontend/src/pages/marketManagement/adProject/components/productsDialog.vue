    ...
    <div class="time-card-select-service">
      <div class="dialog-body-filter-line">
        ...
        <div class="search-box">
          <g-search :placeholder="'搜索产品名称'" v-on:search="handleSearch" v-if="!isSort"></g-search>
      ...
      >
        ...
        <el-table-column label="产品名称" show-overflow-tooltip prop="goodsName" v-if="!isSort"></el-table-column>

  ...
  <div class="stockOut">
    ...
    <div class="body">
      ...
      >
        ...
        <el-table-column prop="endTime" label="出库时间" width="100"></el-table-column>
        <el-table-column prop="type" label="出库类型" width="80"></el-table-column>
        <el-table-column prop="outType" label="出库方式" width="80"></el-table-column>
        <el-table-column prop="outPrice" label="出库价格" width="80"></el-table-column>

        <el-table-column prop="outCount" label="出库数量" width="80"></el-table-column>
        <el-table-column prop="outMoney" label="出库金额" width="80"></el-table-column>
      ...
      <StockFooter type="Out" :total="tableData3.length"></StockFooter>
    </div>
  </div>
</template>
<script>

<template>
  <div>
    ...
    >
      ...
      <el-table-column label="门店业绩收入">
        <el-table-column label="劳动总业绩" prop="performanceRecord.serviceTotalPerformance"></el-table-column>
        <el-table-column label="产品总业绩" prop="performanceRecord.productTotalPerformance"></el-table-column>
      </el-table-column>

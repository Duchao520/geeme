<template>
  <div>
    ...
    >
      ...
      <el-table-column prop="storePerformance" label="门店业绩(￥)"></el-table-column>
      <el-table-column prop="cashPerformance" label="门店现金业绩(￥)"></el-table-column>
    </el-table>
    <div class="page-line">
      <el-pagination
...
export default {
  ...
  methods: {
    init() {
      ...
      axios.post('/getStoreOrderPerformanceInfoList', data).then(res => {
        this.pageLoading = false
        if (res.success) {
          this.tableData = res.performanceInfoResponseList

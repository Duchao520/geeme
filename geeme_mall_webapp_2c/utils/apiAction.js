...
module.exports.getGoodsForFirstPage = function(){
  return new Promise(resolve => {
    ...
    request.post(url, {storeId:wx.$getStorage('storeId')}).then( res => {
      resolve(res.data)
    })
  })
}
...
//获取品牌经营分类列表
module.exports.getCategorySortForApi = function (params) {
  const url = 'getCategorySortForApi'
  return request.post(url, params).then(res => {
    return res.data;
  }).catch(error => {
    return error;
...
//校验指定品牌的行业属性是否为商场
module.exports.getMallBrandFloorInformation = function (params) {
  const url = `getMallBrandFloorInformation/${params.brandId}`
  return request.get(url).then(res => {
    return res.data;
  }).catch(error => {
    return error;
...
//搜索商场门店
module.exports.esMallStoreList = function (params) {
  const url = 'esMallStoreList'
  return request.post(url,params).then(res => {
    return res.data;
  }).catch(error => {
    return error;
...
//商城员工动态
module.exports.getMallSimpleDynamic = function (params) {
  const url = 'getMallSimpleDynamic'
  return request.post(url, params).then(res => {
    return res.data;
  }).catch(error => {
    return error;
...
//根据品牌ID获取产品分类
module.exports.getProductSortList = function (params) {
  const url = `customer/getProductSortList/${params.brandId}`
  return request.get(url).then(res => {
    return { productSortList: res.data.sortInfos};
  }).catch(error => {
    return error;
  })
}
...
//获取门店服务分类信息
module.exports.getStoreSortInfo = function (params) {
  const url = `customer/getStoreSortInfo/${params.brandId}`
  return request.get(url).then(res => {
    return { serviceSortList: res.data.sortInfos };
  }).catch(error => {
    return error;
  })
}
...
//小程序顾客端根据产品ID获取产品基本信息-- 品牌
module.exports.weGetBrandProductListByCondition = function (params) {
  const url = 'customer/weGetBrandProductListByCondition'
  return request.post(url, params).then(res => {
    return res.data;
  }).catch(error => {
    return error;
...
//根据品牌、服务分类信息获取可用的服务列表
module.exports.getBrandServiceListByStoreIdAndSortInfo = function (brandId,sortOneId, sortTwoId) {
  return new Promise(resolve => {
    const url = 'customer/getBrandServiceListByStoreIdAndSortInfo'
    request.post(url, {
